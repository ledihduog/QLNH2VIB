namespace QuanLyNhaHang.Common
{
    ...
    {
        public static string _code = "const%$#tEch~`'3keY";
        ...
        /// <summary>
        /// Encrypts a string using a specified security key with the option to
        /// hash.
        /// </summary>
        ...
        /// <summary>
        /// Decrypts a specified key against the original security key, with the
        /// option to hash.
        /// </summary>
